...
public class MachineWithDrinks {
    ...
    private Map<BuildingMaterialId, MachineWithDrinksCost> machineWithDrinksCosts;
    ...
    public Map<BuildingMaterialId, MachineWithDrinksCost> getMachineWithDrinksCosts() {
        return machineWithDrinksCosts;
    }

    public void setMachineWithDrinksCosts(Map<BuildingMaterialId, MachineWithDrinksCost> machineWithDrinksCosts) {
